          ...
          Right (_, _) -> do
            ...
            case resolveRoute SlugRoute "test.md" of
              Right (ResolvedRoute out) -> do
                ...
                let siteGraph = HS.fromList ["_site/valid.html"]
                -- checkInternalLinks :: outDir -> siteGraph -> sourcePath -> outPath -> html -> [AnySaraError]
                let errs = checkInternalLinks "_site" siteGraph "test.md" "test.html" html
